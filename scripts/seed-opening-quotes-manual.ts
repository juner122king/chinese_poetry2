...
const LINE_BY_KEY: Record<string, number[]> = {
  ...
  "ding-feng-bo-su-shi": [3, 4],
  "yu-lin-ling-liu-yong": [14, 16],
  "qing-yu-an-xin-qi-ji": [9, 10, 11, 12],
  "die-lian-hua-ou-yang-xiu": [0, 1, 2],
  "zui-hua-yin-li-qing-zhao": [7, 8, 9],
  "huan-xi-sha-yan-shu": [3, 4],
  "huan-xi-sha-yan-shu-2": [3, 4],
