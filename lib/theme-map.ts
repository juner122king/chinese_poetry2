...
export const themeMap: Record<PoemTheme, ThemeVisual> = {
  ...
  "dawn-dusk": {
    ...
    mist: true,
    mountains: "soft",
    // no hard horizon — sunset sits in mountain haze
    particles: "none",
  },
  spring: {
    label: "春",
  ...
  "fish-aquatic": {
    label: "鱼藻",
    gradient:
      "radial-gradient(ellipse 80% 50% at 50% 80%, rgba(30,80,90,0.28) 0%, transparent 50%), linear-gradient(180deg, #060e10 0%, #0a1416 50%, #0D0D0D 100%)",
    accent: "#98c0c0",
    glow: "rgba(50,120,130,0.18)",
    mist: true,
    horizon: true,
    ripples: true,
    particles: "none",
  ...
  wine: {
    label: "对酒",
    gradient:
      "radial-gradient(ellipse 50% 50% at 50% 50%, rgba(178,58,72,0.12) 0%, transparent 55%), linear-gradient(180deg, #100808 0%, #140e0e 50%, #0D0D0D 100%)",
    accent: "#d4a0a8",
    glow: "rgba(178,58,72,0.2)",
    moon: true,
    mist: true,
    particles: "stars",
  },
  ...
  homesickness: {
    label: "思乡",
    gradient:
      "radial-gradient(ellipse 60% 50% at 75% 25%, rgba(160,170,200,0.15) 0%, transparent 50%), linear-gradient(180deg, #08090e 0%, #0e1016 50%, #0D0D0D 100%)",
    accent: "#c0c8d8",
    glow: "rgba(160,180,210,0.2)",
    moon: true,
    mist: true,
    mountains: "soft",
    particles: "stars",
